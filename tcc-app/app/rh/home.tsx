...
import { buscarFuncionarios, buscarSetores } from "../../services/api";

type TabType = "funcionarios" | "setores";
  ...
  const renderFuncionarios = () => (
    <>
      <TouchableOpacity
        ...
        onPress={() => router.push("/rh/funcionarios")}
      >
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <View>
          <Text style={styles.headerTitle}>Painel RH</Text>
          <Text style={styles.headerBadge}>Recursos Humanos</Text>
        </View>
      ...
      <View style={styles.bottomMenu}>
        ...
        <TouchableOpacity onPress={() => router.push("/rh/perfil")}>
...
const styles = StyleSheet.create({
  ...
  headerBadge: { color: "#E0D4FF", fontSize: 12, marginTop: 2 },
  tabBar: {
    flexDirection: "row",
    backgroundColor: "#fff",
